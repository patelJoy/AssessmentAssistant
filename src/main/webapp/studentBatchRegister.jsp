      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add New Batch</h1>
          </div>
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Upload the doucment for adding the batch</h6>
                </div>
                <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-lg-5 mx-auto">
                          ...
                          <div class="p-5 bg-white shadow rounded-lg"><img src="C:\Users\Bhavya\Desktop\images.png" alt="" width="200" class="d-block mx-auto mb-4 rounded-pill">
                  			<form class="user" method="POST" enctype="MULTIPART/FORM-DATA" action="DataImport">
                  			<div class="col-sm-6">
                    			<input type="text" class="custom-file-label rounded-pill" id="batch" name="batch" placeholder="Batch e.g. 2020">
                  			</div>
                  			<br>
                  			<br>
                  			<br>
